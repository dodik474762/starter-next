              ...
              <form className="space-y-4">
                ...
                <div>
                  ...
                  <div className="relative flex items-center">
                    <InputElement
                      ...
                      className="w-full text-sm border border-gray-300 px-4 py-3 rounded-lg outline-blue-600"
                    />
                    <svg
                ...
                <div className="!mt-8">
                  <ButtonDefaultElement
                    ...
                    className="w-full shadow-xl py-3 text-sm tracking-wide rounded-lg text-white bg-gray-900 hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-gray-800"
                  />
                </div>
